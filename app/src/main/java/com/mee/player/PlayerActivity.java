...
public class PlayerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOpen.setBackground( getResources().getDrawable( R.drawable.ripple ) );
        ...
        if (isPiPSupported()) {
            ...
            buttonPiP.setBackground( getResources().getDrawable( R.drawable.ripple ) );
        ...
        buttonAspectRatio.setBackground( getResources().getDrawable( R.drawable.ripple ) );
        ...
        buttonRotation.setBackground( getResources().getDrawable( R.drawable.ripple ) );
        ...
        RelativeLayout.LayoutParams titleTextViewLayoutParams = new RelativeLayout.LayoutParams( RelativeLayout.LayoutParams.MATCH_PARENT , RelativeLayout.LayoutParams.WRAP_CONTENT );
        ...
        titleView.setLayoutParams( titleTextViewLayoutParams );
